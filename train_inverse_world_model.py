...
from mirage.inverse_world_model.trainer import InverseWorldModelTrainer
...
def parse_args() -> tuple[dict, str]:
    ...
    p.add_argument("--config", type=str,
                   default=os.path.join(_PROJECT_ROOT, "config", "inverse_world_model", "inverse.yaml"))
...
def main():
    ...
    InverseWorldModelTrainer(cfg).train()
